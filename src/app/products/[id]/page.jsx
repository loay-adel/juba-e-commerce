...
export default function ProductDetailPage({ params }) {
  ...
  const { currentProduct, products, status } = useSelector(
  ...
  useEffect(() => {
    dispatch(fetchProductById(id)), dispatch(fetchProducts());
  }, [id, dispatch]);
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className={`w-4 h-4 {t('price_prefix')}{
          ...
          <div className="flex items-center gap-2 text-sm">
            {currentProduct.stock ? (
              <>
                ...
                <span className="text-gray-500 dark:text-gray-400">
                  · {t("product.ships_in")} 1-2 {t("product.days")}
                </span>
              </>
            ) : (
              <>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg border border-gray-200 dark:border-gray-600">
            <div className="flex items-start gap-3">
              <Truck className="w-5 h-5 text-indigo-500 mt-0.5 flex-shrink-0" />
              <div>
                <p className="font-medium dark:text-white">
                  {t("product.free_shipping")}
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {t("product.free_shipping_details")}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 pt-2">
            {/* Add to Cart */}
            <Button
              className={`flex-1 py-6 text-base font-medium {t('price_prefix')}{
                isInCart
            ...
            <Button
              ...
              size="icon"
              className={`w-14 h-14 {t('price_prefix')}{
                isInWishlist
            ...
            >
              <Heart
                className={`w-5 h-5 {t('price_prefix')}{
      ...
      <div className="mt-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {(products || [])
            ...
            .map((prod) => (
              <Link
                href={`/products/{t('price_prefix')}{prod._id}`}
                key={prod._id}
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center mt-1 mb-2">
                    {[...Array(5)].map((_, i) => (
                      <Star
                        key={i}
                        className={`w-3 h-3 {t('price_prefix')}{
...
function DetailRow({ label, value, valueClass = "" }) {
  return (
    <div className="flex">
      ...
      <span
        className={`flex-1 dark:text-white {t('price_prefix')}{valueClass}`}
      >
        {value}
      </span>
    </div>
